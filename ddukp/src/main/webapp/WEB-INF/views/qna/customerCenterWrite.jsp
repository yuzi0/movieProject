			...
			.ready(
					function() {
				 		$("#freewrite").on('click',function() {
											...
											var textarea = CKEDITOR.instances.qeditor
													.getData();
											if (textarea
													.replace(
...
<div class="logo-menu">
	...
	<div id="content">
		<div class="container">
			<div class="">
				<div class="">
					<form action="customerCenterWriteOk.do" method="post" name="fw">
						<div class="col-md-3 form-group is-empty">
							<label for="moviegenre">카테고리</label> <select id="qctgname" name="qctgname"
								...
								<option value="로그인/회원">로그인/회원</option>
						...
						<div class="col-md-12" style="padding-top: 30px">
							<a href="customerCenter.do?cpage=${param.cpage}"
