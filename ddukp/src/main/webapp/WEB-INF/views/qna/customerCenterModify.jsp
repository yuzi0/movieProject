...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		$("#qctgname option").each(function(){
			if($(this).val()=="${qTO.qctgname}"){
		...
		$("#freewrite").on('click',function(){
			...
			if ($('input[name=qsubject]').val() == '') {
				alert('제목을 입력해주세요.');
				return false;
			}
			var textarea=CKEDITOR.instances.qeditor.getData();
...
<div class="logo-menu">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="breadcrumb-wrapper">
						<h2 class="product-title">고객센터 글 수정</h2>
						<ol class="breadcrumb">
							<li><a href="main.do"><i class="ti-home"></i> MOVIEP</a></li>
							<li class="current">고객센터 글 수정</li>
						</ol>
					</div>
				</div>
			</div>
	...
	<div id="content">
		<div class="container">
			<div class="">
				<div class="">
					<form action="customerCenterModifyOk.do" method="post" name="fw">
					<input type="hidden" name="cpage" value="${param.cpage}" />
					<input type="hidden" name="qnum" value="${param.qnum}" />
						<div class="col-md-3 form-group is-empty">
							<label for="moviegenre">카테고리</label> <select id="qctgname" name="qctgname"
								class="form-control">
								<option selected="selected" value="non">선택해주세요</option>
								<option value="non">로그인/회원</option>
						...
						<div class="col-md-9 form-group is-empty">
							<label for="moviegenre">제목</label> <input type="text" id="qsubject" name="qsubject"
								class="form-control" value="${qTO.qsubject}">
						</div>
						<div class="col-md-12 form-group">
							<label for="moviegenre">내용</label>

							<textarea name="qeditor" id="qeditor" rows="10" cols="10"
								class="form-control" style='width: 100%; min-width: 160px;'>${qTO.qcontent}</textarea>
