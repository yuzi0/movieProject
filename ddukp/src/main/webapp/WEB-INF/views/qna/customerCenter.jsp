   ...
   <div id="content">
      <div class="container">
                     ...
                     <div class="panel-heading">
                        <h4 class="panel-title">
                           <a data-toggle="collapse" data-parent="#accordion"
                              href="#collapseOne"> 회원 신고는 어디서 하나요? </a>
                        </h4>
                     </div>
                     <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body" style="text-align : center">
                           <p>글 주소를 고객센터에 이유와 함께 작성해서 보내주시면<br> 관리자가 차단 이유에 맞다면 탈퇴를 시켜줄겁니다.</p>
               ...
               <div class="panel-group" id="accordion">
                  <div class="panel panel-default">
                     <div class="panel-heading">
                        <h4 class="panel-title">
                           <a data-toggle="collapse" data-parent="#accordion"
                              href="#collapseOne1"> 사이트를 이용하는데 버그들이 생겨요 </a>
                        </h4>
                     </div>
                     <div id="collapseOne1" class="panel-collapse collapse">
                        <div class="panel-body" style="text-align : center">
                           <p>버그들을 캡쳐해주시거나 상세 설명을 작성해서 고객센터에 작성해주세요.<br>
                           관리자들이 빠르게 고칠 것입니다.</p>
                        </div>
                     </div>
                  </div>
         ...
         <div class="job-alerts-item">
            ...
            <c:choose>
            <c:when test="${empty lLTO.customerList }">
            ...
            <c:forEach items="${lLTO.customerList}" var="to">
               <div class="alerts-content">
                  <div class="row">
                     ...
                     <a href="customerCenterView.do?qnum=${to.qnum }&cpage=${lLTO.cpage}">
                        ...
                        <div class="col-md-5 col-xs-4">
                           ...
                           <c:if test="${to.qgap==0 }">
                              ...
                              [${ to.qctgname}]&nbsp&nbsp${ to.qsubject}
                           </p>
                        </div>
         ...
         <div class="col-md-12" style="padding: 20px">
            <c:if test="${!empty sid}">
               ...
               <a href="customerCenterWrite.do?cpage=${lLTO.cpage}" class="btn btn-common pull-right">쓰기</a>
            </c:if>
         </div>
