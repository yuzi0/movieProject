	...
	<div id="content">
		<div class="container">
						...
						<div class="col-md-3 col-xs-4">
							<div class="search-category-container1">
										<select class="dropdown-product selectpicker" name="opt">
											...
											<option value="0"
												${lLTO.searchKey eq "0" ? "selected" :"" }>제목</option>
											<option value="1"
												${lLTO.searchKey eq "1" ? "selected" :""}>내용</option>
										</select>
							</div>
						</div>
			...
			<div class="job-alerts-item">
				...
				<c:choose>
				<c:when test="${empty lLTO.columnList }">
			...
			<div style="text-align: center; padding-top: 50px">
				<ul class="pagination">
					...
					<c:choose>
						...
						<c:otherwise>
									<c:choose>
										<c:when test="${not empty lLTO.searchWord }">
											<li class="active"><a
												href="columnList.do?cpage=${lLTO.cpage-1}&opt=${lLTO.searchKey}&searchText=${lLTO.searchWord}"
						...
						<c:choose>
							...
							<c:otherwise>
										<c:choose>
											...
											<c:when test="${not empty lLTO.searchWord }">
												<li><a
													href="columnList.do?cpage=${i}&opt=${lLTO.searchKey}&searchText=${lLTO.searchWord}">${i}</a></li>
