		...
		$("#csubmit").on('click',function(){
	 	 ...
	 	 CommentList();
							...
							success : function(data) {
								...
								if (data.length > 0) {
									for (var i = 0; i < data.length-1; i++) {
										...
										chtml+="<div class='"+data[i].icnum+"' id='com'>";
										chtml+="<h5 class='name'>"+data[i].number+"</h5>";
										chtml+="<p>"+data[i].comment+"</p>";
										chtml+=	"<span class='comment-date'>"+data[i].icdate+"</span>&nbsp;&nbsp;&nbsp;"; 
			...
			$('.comments-list').on('click','#deletebtn',function(){
				$.ajax({
					type : 'get',
					url : 'infoCommentDelete.do',
					data :{ icnum:$('#com').attr('class')},
				...
				<div class="">
					<table class="table table-borderless table-sm">
						...
						<tr>
							...
							<th class="col-md-2" style="text-align: right;">${iTO.commentNum}</th>
						</tr>
					</table>
		...
		<div class="container">
			<div id="comments" class="col-md-10 col-md-offset-1">
				...
				<div id="respond">
					...
					<input type="hidden" name="inum" value="${iTO.inum}"> 
