...
<title>후기게시판</title>
	...
	$(document).ready(function () {
		...
		$("#ictgname option").each(function(){
			if($(this).val()=="${iTO.ictgname}"){
		...
		$("#freewrite").on('click',function(){
			...
			var textarea=CKEDITOR.instances.ieditor.getData();
...
<div class="logo-menu">
	...
	<div id="content">
		<div class="container">
			<div class="">
				<div class="">
					<form action="infoModifyOk.do" method="post" name="fw">
					...
					<input type="hidden" name="inum" value="${param.inum}" />
						...
						<div class="col-md-9 form-group is-empty">
							<label for="moviegenre">제목</label> <input type="text" id="isubject"  name="isubject"
								class="form-control" value="${iTO.isubject}">
						</div>
						<div class="col-md-12 form-group">
							<label for="moviegenre">내용</label>

							<textarea name="ieditor" id="ieditor" rows="10" cols="10"
								class="form-control" style='width: 100%; min-width: 160px;'>${iTO.icontent}</textarea>

						</div>
		
						<div class="col-md-12" style="padding-top: 30px">
							<a href="infoList.do?cpage=${param.cpage}" class="btn btn-common pull-left">목록</a>
