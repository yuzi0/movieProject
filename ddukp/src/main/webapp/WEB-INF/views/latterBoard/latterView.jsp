						...
						success : function(data) {
							...
							if (data.length > 0) {
								for (var i = 0; i < data.length-1; i++) {
									...
									chtml+="<div class='"+data[i].rcnum+"' id='com'>";
									chtml+="<h5 class='name'>"+data[i].number+"</h5>";
									chtml+="<p>"+data[i].comment+"</p>";
									chtml+=	"<span class='comment-date'>"+data[i].rcdate+"</span>&nbsp;&nbsp;&nbsp;"; 
				...
				<ul class="nav navbar-nav">
					...
					<li><a class="active" href="freeList.do"> 커뮤니티 <i
						...
						<ul class="dropdown">
							...
							<li><a class="active" href="latterList.do"> 후기 게시판 </a></li>
						</ul></li>
		...
		<div class="container">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="">
					<table class="table table-borderless table-sm">
						...
						<tr>
							...
							<th class="col-md-2" style="text-align: right;">${lTO.commentNum}</th>
						</tr>
					</table>
				...
				<div class="col-md-12" style="padding-top: 30px">
					<a href="latterList.do?cpage=${param.cpage}" class="btn btn-common pull-left" id="list">목록</a> 
					<c:if test="${!empty sid && sid eq lTO.uid }">
					...
					<a href="infoEdit.do?rnum=${param.rnum}&cpage=${param.cpage}" class="btn btn-common pull-right"
						id="btn-left1">삭제</a>
						 ...
						 <c:if test="${(!empty sid && sid eq lTO.uid) || lTO.anum > 0}">
		...
		<div class="container">
			<div id="comments" class="col-md-10 col-md-offset-1">
				...
				<div id="respond">
					...
					<input type="hidden" name="rnum" value="${lTO.rnum}"> 
