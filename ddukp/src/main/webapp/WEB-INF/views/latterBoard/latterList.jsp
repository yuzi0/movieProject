							...
							<a href="latterView.do?rnum=${to.rnum }&cpage=${lLTO.cpage}">
								...
								<div class="col-md-5 col-xs-4">
									...
									<img src='./assets/img/board/mark_new2.gif'
										...
										[${ to.msubject}]&nbsp&nbsp${ to.rsubject}
									</p>
								</div>
						...
						<c:otherwise>
									<c:choose>
										<c:when test="${not empty lLTO.searchWord }">
											<li class="active"><a
												href="latterList.do?cpage=${lLTO.cpage-1}&opt=${lLTO.searchKey}&searchText=${lLTO.searchWord}"
						...
						<c:choose>
							...
							<c:otherwise>
										<c:choose>
											...
											<c:when test="${not empty lLTO.searchWord }">
												<li><a
													href="latterList.do?cpage=${i}&opt=${lLTO.searchKey}&searchText=${lLTO.searchWord}">${i}</a></li>
