	...
	<div id="content">
		<div class="container">
			<div class="col-sm-12 col-md-9 col-md-offset-2">
				...
				<div class="card">
					<img src="./assets/img/movie/movie_image.jpg" class="card-img-top"
						alt="...">
					<div class="card-body">
						<h1 class="card-title" style="text-align: center;">영화이름</h1>
					...
					<ul class="list-group list-group-flush">
						<li class="list-group-item">
							...
							<p>
								사이트 : <a
									href="https://series.naver.com/movie/detail.nhn?productNo=4462861">바로가기</a>
							</p>
							<p>할인 : 그런거 음다</p>
							<p>이벤트 : [캐시] 추석연휴 캐시백 이벤트! 최대 1만 2천 캐시 돌려받자</p>
							<p>
						...
						<li class="list-group-item">
							...
							<p>가격 : 10000원</p>
							<p>
								사이트 : <a href="https://www.youtube.com/watch?v=47ZSLkyuWi4">바로가기</a>
							</p>
							<p>할인 : 그런거 음다</p>
							<p>이벤트 : [캐시] 추석연휴 캐시백 이벤트! 최대 1만 2천 캐시 돌려받자</p>
							<p>
		...
		<script type="text/javascript"
			src="./assets/js/jasny-bootstrap.min.js"></script>
		<script type="text/javascript"
